                ...
                <tr>
                    <td>
                        <table cellpadding="1">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:HyperLink ID="HyperLink1" style="color: white;" CssClass="login-reg login-font" runat="server" NavigateUrl="~/WebPages/Register.aspx">Create an account</asp:HyperLink>
                                </td>
                            </tr>

                            <tr>
                                <td align="center" colspan="2" style="color: crimson; font-family: monospace;">
                                    <asp:Label ID="lblFail" runat="server" style="color: crimson; font-size: small; " Visible="False"></asp:Label>
                                </td>
                            </tr>
